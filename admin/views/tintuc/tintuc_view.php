...
?>
     ...
     <form class="form-inline" action="tintuc.php" method="GET">
        <div class="form-group">
         <input type="" class="form-control" id="" placeholder="Nhập Tiêu đề..." name="tieude" value="<?php echo $tieude ?>">
        </div>
  ...
  <div class="main-content">
    <div class="panel panel-default">
     <table class="table" border="1" width="100%">
      ...
      <tbody>
      <?php while ($row=mysql_fetch_row($dstt)) { ?>
       <tr>
        ...
        <td style="text-align:center;padding-top:25px"><a href="?controller=tintuc&action=read&id=<?php echo $row[0] ?>">Xem</a></td>
        ...
        <td style="text-align:center;padding-top:25px">
          <a href="?controller=tintuc&action=edit&id=<?php echo $row[0] ?>"><i class="fa fa-pencil"></i></a>
          <i class="fa fa-trash-o" onClick="confirmDelete('tintuc',<?php echo $row[0] ?>)"></i>
        </td>
       </tr>
       <?php } ?>
      </tbody>
