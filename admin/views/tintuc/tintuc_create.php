...
<div class="content">
  <div class="header">
    <h1 class="page-title">Thêm Tin tức</h1>
  </div>

  <div class="main-content">
    <div class="">
    <form action="tintuc.php" method="POST" enctype="multipart/form-data">
    <div>
    ...
    <div>
        ...
        <div class="col-sm-10"><input type="submit" value="Tạo" name="btn_tao_tintuc"></div>
    </div>
    </form>
    </div>
