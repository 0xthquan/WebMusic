...
<div class="content">
  <div class="header">
    <h1 class="page-title">Chỉnh sửa Tin HOT</h1>
  </div>

  <div class="main-content">
    <div class="">
    <form action="tinhot.php?id=<?php echo $id ?>" method="POST" enctype="multipart/form-data">
    <div>
    ...
    <div>
        ...
        <div class="col-sm-10"><input type="submit" value="Sửa" name="btn_sua_tinhot"></div>
    </div>
    </form>
    </div>
